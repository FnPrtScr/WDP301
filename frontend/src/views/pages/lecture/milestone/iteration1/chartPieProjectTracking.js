...
const ChartPieComponent = ({ width, height, dataProjectTracking }) => {
  ...
  const data = {
    ...
    datasets: [{// eslint-disable-line
      ...
      data: [dataProjectTracking && dataProjectTracking ? dataProjectTracking.totalToDo : 0, dataProjectTracking && dataProjectTracking ? dataProjectTracking.totalInProgress : 0, dataProjectTracking && dataProjectTracking ? dataProjectTracking.totalDone : 0],
      backgroundColor: [// eslint-disable-line
        Utils.CHART_COLORS.blue,
        Utils.CHART_COLORS.red,
        Utils.CHART_COLORS.green
      ],// eslint-disable-line
      hoverOffset: dataProjectTracking && dataProjectTracking ? dataProjectTracking.totalIssues : 0
    }]// eslint-disable-line
  }
  const config = {
    type: 'pie',
