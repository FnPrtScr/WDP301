...
class RequestService {
    ...
    async createRequestProject(req, res, next) {
        ...
        try {
            ...
            const getStartDateSemester = new Date(checkSemesterActive.startDate);
            const timeDifference = currentTime.getTime() - getStartDateSemester.getTime();
            const differenceInDays = timeDifference / (1000 * 3600 * 24);
            const isOverTwoWeeks = differenceInDays > 14;
            if(isOverTwoWeeks) throw new ErrorResponse(500,"The time to create a request topic has passed")
